  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-20 text-center space-y-3">
        ...
        <Link
          href="/"
          className="inline-block mt-2 px-4 py-2 rounded-full bg-orange-400 text-neutral-900 font-medium"
        >
          Continue shopping
        </Link>
      </div>
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8">
      ...
      <aside className="h-fit p-5 rounded-2xl border border-black/10 dark:border-white/10 sticky top-20">
        ...
        <button className="mt-4 w-full py-2.5 rounded-full bg-yellow-400 hover:bg-yellow-500 text-neutral-900 font-medium">
          Proceed to checkout
        </button>
